...
from quantitativetrader.api.rest import RestClient, Request
from quantitativetrader.api.websocket import WebsocketClient
...
from quantitativetrader.trader.gateway import BaseGateway
...
class BinanceGateway(BaseGateway):
    """
    Quantitative Trading Robots Gateway for Binance connection.
    """
