...
def create_qapp(app_name: str = "Quantitative Trading Robots") -> QtWidgets.QApplication:
    """
    ...
    icon = QtGui.QIcon(get_icon_path(__file__, "robot.ico"))
...
class ExceptionDialog(QtWidgets.QDialog):
    ...
    def init_ui(self) -> None:
        ...
        copy_button.setStyleSheet("QPushButton{color:black}"
        ...
        community_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
