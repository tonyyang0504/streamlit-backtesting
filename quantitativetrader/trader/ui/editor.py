...
class FindDialog(QtWidgets.QDialog):
    ...
    def init_ui(self) -> None:
        ...
        find_button.setStyleSheet("QPushButton{color:black}"
        ...
        self.replace_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
...
if __name__ == "__main__":
    from quantitativetrader.trader.ui import create_qapp
