"""
Implements main window of Quantitative Trading Robots.
"""
...
class MainWindow(QtWidgets.QMainWindow):
    """
    Main window of Quantitative Trading Robots.
    """
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine):
        ...
        self.window_title: str = "Quantitative Trading Robots"
    ...
    def init_dock(self) -> None:
        ...
        tick_widget, tick_dock = self.create_dock(
            TickMonitor, "行情", QtCore.Qt.LeftDockWidgetArea
        )
        ...
        position_widget, position_dock = self.create_dock(
            PositionMonitor, "持仓", QtCore.Qt.LeftDockWidgetArea
        )
    ...
    def init_menu(self) -> None:
        ...
        # System menu
        sys_menu = bar.addMenu("市场")

        gateway_names = self.main_engine.get_all_gateway_names()
        for name in gateway_names:
            func = partial(self.connect, name)
            if name == "BINANCE":
                self.add_menu_action(sys_menu, "连接现货交易市场", "connect.ico", func)
            elif name == "BINANCES":
                self.add_menu_action(sys_menu, "连接合约交易市场", "connect.ico", func)
        ...
        action = QtWidgets.QAction("设置", self)
        ...
        self.add_menu_action(
            help_menu, "帮助文档", "email.ico", self.send_test_email
        )
    ...
    def closeEvent(self, event: QtGui.QCloseEvent) -> None:
        ...
        box.button(QtWidgets.QMessageBox.Yes).setText("确定")
        box.button(QtWidgets.QMessageBox.No).setText("取消")
    ...
    def send_test_email(self) -> None:
        ...
        """
        self.main_engine.send_email("Quantitative Trading Robots", "testing")

    def open_forum(self) -> None:
        """
        """
        webbrowser.open("https://genfisupport.zendesk.com/hc/zh-cn/")
