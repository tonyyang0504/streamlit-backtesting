...
class MainEngine:
    """
    Acts as the core of Quantitative Trading Robots.
    """
...
class LogEngine(BaseEngine):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine):
        ...
        self.logger: Logger = logging.getLogger("Quantitative Trading Robots")
...
class OmsEngine(BaseEngine):
    """
    Provides order management system function for Quantitative Trading Robots.
    """
...
class EmailEngine(BaseEngine):
    """
    Provides email sending function for Quantitative Trading Robots.
    """
