...
from quantitativetrader.trader.ui import QtWidgets, QtCore
from quantitativetrader.trader.engine import MainEngine, EventEngine
from quantitativetrader.trader.constant import Interval, Exchange
...
class ManagerWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        refresh_button.setStyleSheet("QPushButton{color:black}"
        ...
        import_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
        ...
        update_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
        ...
        download_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
    ...
    def refresh_tree(self) -> None:
        ...
        for d in data:
            ...
            if not item:
                ...
                output_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(66, 133, 244)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
                ...
                show_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(52, 168, 83)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
                ...
                delete_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(234, 67, 53)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
...
class ImportDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        file_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
        ...
        load_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
        ...
        self.symbol_edit.setStyleSheet(
                        '''QLineEdit{
                        border:1px solid grey;
                        width:200px;
                        border-radius:10px;
        ...
        self.volume_edit.setStyleSheet(
                        '''QLineEdit{
                        border:1px solid grey;
                        width:200px;
                        border-radius:10px;
        ...
        self.open_interest_edit.setStyleSheet(
                        '''QLineEdit{
                        border:1px solid grey;
                        width:200px;
                        border-radius:10px;
