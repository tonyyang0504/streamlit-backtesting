...
class AlgoWidget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        start_algo_button.setStyleSheet("QPushButton{color:black}"
        ...
        load_csv_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
        ...
        self.setting_name_line.setStyleSheet(
                        '''QLineEdit{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
        ...
        save_setting_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
...
class SettingMonitor(QtWidgets.QTableWidget):
    ...
    def get_setting_cells(self, setting_name: str):
        ...
        if not cells:
            ...
            use_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
...
class AlgoManager(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        stop_all_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
