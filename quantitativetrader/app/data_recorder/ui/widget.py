...
from quantitativetrader.trader.ui import QtCore, QtWidgets
from quantitativetrader.trader.event import EVENT_CONTRACT
...
class RecorderManager(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        add_bar_button.setStyleSheet("QPushButton{color:black}"
        ...
        remove_bar_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
        ...
        add_tick_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
        ...
        remove_tick_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
        ...
        self.bar_recording_edit.setStyleSheet(
                        '''QTextEdit{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
        ...
        self.tick_recording_edit.setStyleSheet(
                        '''QTextEdit{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
