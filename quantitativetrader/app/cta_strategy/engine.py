...
from quantitativetrader.trader.engine import BaseEngine, MainEngine
...
from quantitativetrader.trader.event import (
    EVENT_TICK,
    EVENT_BAR,
    EVENT_ORDER,
    EVENT_TRADE,
...
from quantitativetrader.trader.constant import (
    Direction,
    OrderType,
    Interval,
    Exchange,
...
from quantitativetrader.trader.utility import load_json, save_json, extract_vt_symbol, round_to
from quantitativetrader.trader.converter import OffsetConverter
from quantitativetrader.trader.database import database_manager
from quantitativetrader.trader.converter import OffsetConverter
...
class CtaEngine(BaseEngine):
    ...
    def send_server_order(
        ...
        original_req = OrderRequest(
            ...
            price=price,
            volume=volume,
            reference=strategy.strategy_name
        )
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(
            path1, "quantitativetrader.app.cta_strategy.strategies")
    ...
    def get_strategy_class_parameters(self, class_name: str):
        ...
        if hasattr(strategy_class, 'parameters_map'):
            parameters_map = strategy_class.parameters_map
        else:
            parameters_map = {}
            for name in strategy_class.parameters:
                parameters_map[name] = name

        parameters = {}
        for name in strategy_class.parameters:
            parameters[name] = getattr(strategy_class, name)

        return parameters, parameters_map
