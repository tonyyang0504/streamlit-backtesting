from quantitativetrader.app.cta_strategy import (
    CtaTemplate,
    StopOrder,
    TickData,
    BarData,
...
from quantitativetrader.app.cta_strategy.engine import CtaEngine
from quantitativetrader.trader.event import EVENT_TIMER
from quantitativetrader.event import Event
from quantitativetrader.trader.object import Status, Direction
from quantitativetrader.trader.object import GridPositionCalculator
...
class FutureProfitGridStrategy(CtaTemplate):
    ...
    parameters_map = {
        ...
        "trading_size": "单次下单量", 
        "max_pos": "最大单边下单量", 
        "profit_orders_counts": "止盈网格数", 
        "trailing_stop_multiplier": "止损乘数", 
        "stop_minutes": "策略停止时间"
    }
