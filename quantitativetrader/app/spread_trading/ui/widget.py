...
class SpreadAlgoWidget(QtWidgets.QFrame):
    ...
    def init_ui(self):
        ...
        self.offset_combo.setStyleSheet(
                        '''QComboBox{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
        ...
        self.volume_line.setStyleSheet(
                        '''QLineEdit{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
        ...
        self.interval_line.setStyleSheet(
                        '''QLineEdit{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
        ...
        button_start.setStyleSheet("QPushButton{color:black}"
        ...
        add_spread_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(52, 168, 83)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
        ...
        remove_spread_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(234, 67, 53)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
...
class SpreadDataDialog(QtWidgets.QDialog):
    ...
    def init_ui(self):
        ...
        self.active_line.setStyleSheet(
                        '''QLineEdit{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
        ...
        self.min_volume_combo.setStyleSheet(
                        '''QComboBox{
                        border:1px solid grey;
                        width:300px;
                        border-radius:10px;
...
class SpreadStrategyWidget(QtWidgets.QFrame):
    ...
    def init_ui(self):
        ...
        remove_button.setStyleSheet("QPushButton{color:black}"
                                       "QPushButton:hover{color:grey}"
                                       "QPushButton{background-color:rgb(251, 188, 5)}"
                                       "QPushButton{border:2px}"
                                       "QPushButton{border-radius:10px}"
